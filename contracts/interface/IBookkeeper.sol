...
interface IBookkeeper {
    ...
    function registerFundKeeperEarned(address _token, uint256 _fundTokenAmount)
        external;
    ...
    function registerVaultTransfer(
        address from,
        address to,
        uint256 amount
    ) external;

    function registerUserEarned(
        address _user,
        address _vault,
        address _rt,
        uint256 _amount
    ...
    function registerRewardDistribution(
        address vault,
        address token,
        uint256 amount
    ) external;
    ...
    function lastPpfsChange(address vault)
        external
        view
        returns (PpfsChange memory);
    ...
    function targetTokenEarned(address strategy)
        external
        view
        returns (uint256);
    ...
    function vaultUsersBalances(address vault, address user)
        external
        view
        returns (uint256);
    ...
    function lastHardWork(address vault)
        external
        view
        returns (HardWork memory);
    ...
    function vaultRewards(
        address vault,
        address token,
        uint256 idx
    ) external view returns (uint256);

    function vaultRewardsLength(address vault, address token)
        external
        view
        returns (uint256);

    function strategyEarnedSnapshots(address strategy, uint256 idx)
        external
        view
        returns (uint256);

    function strategyEarnedSnapshotsTime(address strategy, uint256 idx)
        external
        view
        returns (uint256);

    function strategyEarnedSnapshotsLength(address strategy)
        external
        view
        returns (uint256);
}
